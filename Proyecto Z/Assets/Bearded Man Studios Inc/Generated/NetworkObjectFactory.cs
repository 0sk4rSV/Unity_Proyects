			...
			MainThreadManager.Run(() =>
			{
				switch (identity)
				{
					...
					case NetworkCameraNetworkObject.IDENTITY:
						...
						break;
					case R_DesconectaNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new R_DesconectaNetworkObject(networker, id, frame);
						break;
					case R_ObjetoGenericoNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new R_ObjetoGenericoNetworkObject(networker, id, frame);
						break;
					case R_PlayerNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new R_PlayerNetworkObject(networker, id, frame);
						break;
					case R_PowerUpNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new R_PowerUpNetworkObject(networker, id, frame);
						break;
					case R_ZombieNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new R_ZombieNetworkObject(networker, id, frame);
						break;
